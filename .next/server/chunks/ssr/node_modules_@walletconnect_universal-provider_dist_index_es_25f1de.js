...
"[project]/node_modules/@walletconnect/universal-provider/dist/index.es.js [app-rsc] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$sign$2d$client$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@walletconnect/sign-client/dist/index.es.js [app-rsc] (ecmascript)");
...
function Lt(P, s, i) {
    var p;
    const w = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseChainId"])(P);
...
function La(P) {
    var s, i, p, w;
    const I = {};
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isValidObject"])(P)) return I;
    for (const [y, J] of Object.entries(P)){
        const Ht = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isCaipNamespace"])(y) ? [
            y
        ] : J.chains, Ke = J.methods || [], Ie = J.events || [], Dt = J.rpcMap || {}, Bt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(y);
        I[Bt] = nv(lr(lr({}, I[Bt]), J), {
            chains: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["mergeArrays"])(Ht, (s = I[Bt]) == null ? void 0 : s.chains),
            methods: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["mergeArrays"])(Ke, (i = I[Bt]) == null ? void 0 : i.methods),
            events: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["mergeArrays"])(Ie, (p = I[Bt]) == null ? void 0 : p.events),
...
function Ha(P) {
    ...
    for (const [i, p] of Object.entries(P)){
        const w = p.methods || [], I = p.events || [], y = p.accounts || [], J = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isCaipNamespace"])(i) ? [
            i
...
class hv {
    ...
    createHttpProvider(s, i) {
        ...
        if (!p) throw new Error(`No RPC url provided for chainId: ${s}`);
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$provider$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["JsonRpcProvider"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$http$2d$connection$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["HttpConnection"](p, F("disableProviderPing")));
    }
    setHttpProvider(s, i) {
        const p = this.createHttpProvider(s, i);
        p && (this.httpProviders[s] = p);
...
class wv {
    ...
    createHttpProviders() {
        ...
        return (i = (s = this.namespace) == null ? void 0 : s.accounts) == null || i.forEach((w)=>{
            const I = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseChainId"])(w);
...
class dr {
    constructor(s){
        this.events = new __TURBOPACK__commonjs__external__events__["default"], this.rpcProviders = {}, this.shouldAbortPairingAttempt = !1, this.maxPairingAttempts = 10, this.disableProviderPing = !1, this.providerOpts = s, this.logger = typeof s?.logger < "u" && typeof s?.logger != "string" ? s.logger : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pino$2f$pino$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$export__default__as__pino$3e$__["pino"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$logger$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getDefaultLoggerOptions"])({
            level: s?.logger || ya
    ...
    sendAsync(s, i, p, w) {
        ...
        this.request(s, p, w).then((y)=>i(null, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$jsonrpc$2d$utils$2f$dist$2f$esm$2f$format$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["formatJsonRpcResult"])(I, y))).catch((y)=>i(y, void 0));
    }
    async enable() {
    ...
    async pair(s) {
        ...
        do {
            ...
            p && (this.uri = p, this.events.emit("display_uri", p)), await w().then((I)=>{
                ...
                if (I.message !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$sign$2d$client$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PROPOSAL_EXPIRY_MESSAGE"]) throw I;
                i++;
            });
        }while (!this.session)
    ...
    async cleanupPendingPairings(s = {}) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isValidArray"])(i)) {
    ...
    async createClient() {
        this.client = this.providerOpts.client || await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$sign$2d$client$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].init({
    ...
    createProviders() {
        ...
        const s = [
            ...new Set(Object.keys(this.session.namespaces).map((i)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(i)))
        ];
    ...
    registerEventListeners() {
        ...
        this.client.on("session_ping", (s)=>{
            ...
            if (p.name === "accountsChanged") {
                const w = p.data;
                w && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isValidArray"])(w) && this.events.emit("accountsChanged", w.map(iv));
            } else if (p.name === "chainChanged") {
                const w = i.chainId, I = i.event.data, y = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(w), J = Wi(w) !== Wi(I) ? `${y}:${Wi(I)}` : w;
            ...
            await this.cleanup(), this.events.emit("session_delete", s), this.events.emit("disconnect", Bi(pr({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSdkError"])("USER_DISCONNECTED")), {
                data: s.topic
            }));
    ...
    validateChain(s) {
        ...
        if (i && !Object.keys(this.namespaces || {}).map((y)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(y)).includes(i)) throw new Error(`Namespace '${i}' is not configured. Please call connect() first with namespace config.`);
        if (i && p) return [
            i,
            p
        ];
        const w = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["parseNamespaceKey"])(Object.keys(this.namespaces)[0]), I = this.rpcProviders[w].getDefaultChain();
        return [
            w,
            I
        ];
...
//# sourceMappingURL=node_modules_%40walletconnect_universal-provider_dist_index_es_25f1de.js.map